...
function deploySearch(e){var i;switch(e){case"ARS":i="$";break;case"USD":i="U$S"}return i}function deployImage(e){return e.replace("-I.jpg","-V.jpg")}$(document).ready(function(){var t=$("#domain").val();0<$(".page-results").length&&$(".nav-search").submit(function(e){e.preventDefault();var i=$(this).find(".nav-search-input").val();$.ajax({url:"ajax.php",data:{q:i,action:"getItemsSearch"},type:"POST",dataType:"json",beforeSend:function(){$("#searchResults").addClass("loading").find(".container").html("")},success:function(e){$("#searchResults").removeClass("loading"),$.each(e,function(e,i){var a="";a+='<div class="item"><a href="'+t+"product.php?id="+i.id+'" class="item__image"><img src="'+deployImage(i.thumbnail)+'" alt="'+i.title+'" width="160" heigth="160"></a>',a+='<div class="item__info">',a+='<div class="item__price__container"><div class="item__price">'+deploySearch(i.currency_id)+i.price+"</div>",1==i.shipping.free_shipping&&(a+=' <div class="item__shopping-cart"></div>'),a+='</div><h2 class="item__title"><a href="'+t+"product.php?id="+i.id+'">'+i.title+"</a></h2>",a+='<div class="item__location">'+i.address.city_name+"</div></div></div>",$("#searchResults .container").append(a)})},error:function(e,i,a){console.log(e),console.log(i),console.log(a)}})})});